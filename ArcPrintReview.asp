...
Set adCmd = GetAdoCmd("spArcRvwGet4Print")
...
Call AddTableColumn(350,"<B>Signature:</B> " & adRs.Fields("rvwSupSig").value,False,"TableRow")
Call EndTableBody()
Call StartTableBody()
...
Call AddTableColumn(350,"<B>Worker Acknowledgement:</B> " & adRs.Fields("rvwWrkSig").value,False,"TableRow")
Call EndTableBody()
Call StartTableBody()
...
Call EndTableBody()
Call StartTableBody()
Call AddTableColumn(350,"<B>Office Manager:</B> " & adRs.Fields("OfficeManager").value,False,"TableRow")
Call AddTableColumn(350,"<B>FIPs:</B> " & adRs.Fields("FIPs").value,False,"TableRow")
Call EndTableBody()
Call StartTableBody()
Call AddTableColumn(350,"<B>Region:</B> " & adRs.Fields("Region").value,False,"TableRow")
Call AddTableColumn(350,"&nbsp;",False,"TableRow")
Call EndTableBody()
Call EndTable()
Response.Write "<BR>"
...
Do While Not adRsPrgs.EOF
    ...
    If adRsPrgs.Fields("ProgramID").value >= 50 Or adRsPrgs.Fields("ProgramID").value = 6 Then
        Call SingleLineTable(adRsPrgs.Fields("ProgramName").value, "FunctionHeader", 10)
    Else
        Call SingleLineTable(adRsPrgs.Fields("ProgramName").value & " -- " & adRsPrgs.Fields("ReviewType").value, "FunctionHeader", 10)
    End If
    adRsElms.Filter = "rveReviewID=" & mlngReviewID & " And ProgramName='" & adRsPrgs.Fields("ProgramName").value & "'"
            ...
            Select Case adRsElms.Fields("rveType").value
                ...
                Case "Data Integrity"
                    ...
                    adRsFacs.Filter = "rvfReviewID=" & mlngReviewID & _
                                      " And ProgramName=" & adRsPrgs.Fields("ProgramName").value & _
                                      " And ElementName=" & adRsElms.Fields("ElementName").value
